...
class SKY_CORE_EXPORT WLocalObject : public QObject, public WPrivatable
{
    Q_OBJECT
...
class SKY_CORE_EXPORT WLocalObjectReplySave : public WAbstractThreadReply
{
    Q_OBJECT
...
class SKY_CORE_EXPORT WLocalObjectReplyLoad : public WAbstractThreadReply
{
    Q_OBJECT
